...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-green-50 dark:bg-zinc-900 border-b-1 border-green-400 shadow-md transition-colors duration-300">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="lg:hidden ml-1">
              <button
                ...
                className="p-2 rounded-md text-green-700 dark:text-green-300 hover:bg-green-100 dark:hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-green-500"
